...
const DoctrineCertification: React.FC = () => {
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div key={item.id} className="px-6 py-4 hover:bg-gray-50 transition-colors duration-200">
                   ...
                   <div className="col-span-4">
                     <div className="flex items-center space-x-2">
                       ...
                       {item.views > 1000 && (
                         <span className="bg-red-100 text-red-800 text-xs px-2 py-1 rounded-full">인기</span>
                       )}
                     </div>
                   </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-8 text-center text-white">
          <h2 className="text-2xl font-bold mb-4">교리 반증 자료 신청하기</h2>
...
export default DoctrineCertification;

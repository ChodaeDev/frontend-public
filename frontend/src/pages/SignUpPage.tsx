  ...
  return (
    <div className="flex h-full items-center justify-center bg-gradient-to-tl from-purple-100 via-white to-blue-100">
      <div className="w-full max-w-2xl rounded-3xl bg-white p-10 shadow-2xl">
        <h1 className="mb-2 text-3xl font-bold text-gray-900 text-center">회원가입</h1>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          {successMessage && (
            <div className="md:col-span-2 rounded-lg bg-green-50 px-4 py-3 text-sm text-green-600">
              {successMessage}
            </div>
          )}

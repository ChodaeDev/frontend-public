            ...
            return (
              <li key={sub.slug}>
                <Link
                  ...
                  className={cn('block py-2.5 px-3 rounded-lg transition-all duration-300', isActive ? 'font-bold text-accent1 bg-gray9' : 'text-sub hover:text-main hover:bg-gray9')}
                >
                  {sub.label}
                </Link>
              </li>

...
@Tag(name = "신천지 위치정보", description = "신천지 위치정보 페이지 관련 API")
@Slf4j
@RestController
@RequestMapping("/api/prevention/locations")
@CrossOrigin(origins = "*")
...
public class LocationsController {
    ...
    public ApiResponse<PagedListResponse<PreventionResponse>> getList(
        ...
        PagedListResponse<PreventionResponse> list = preventionService.findAllWithPaging(pageNumber, itemCount, pageSize, sorting);

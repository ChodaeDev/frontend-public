...
export default function LandingImageSection({
  ...
  return (
    <section className={'animate-fadeIn w-full my-10'}>
      ...
      <div className={'w-full flex lg:hidden flex-col sm:flex-row items-center gap-10 sm:gap-4 pt-4'}>
        <div className={'w-full'}>
          <h1 className={'animate-heroSlideUp text-2xl font-bold text-main'}>
            {dictionary.home.title || '신천지 전문 구리 이단 상담소'}
          </h1>
          <p className={'animate-heroSlideUp-delay-1 text-base text-gray1 mt-2'}>
            {dictionary.home.subtitle || '신천지로 인한 문제가 있을 경우 적극적으로 도움을 드리겠습니다.'}
          </p>
        </div>
